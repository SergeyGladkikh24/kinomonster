<h1><?php echo $title." "; ?>
  <?php if($this->dx_auth->is_admin()) { ?>
        <a href="/movies/edit/<?php echo $slug; ?>" title = 'Рeдактировать фильм/сериал'><button type="button" class="btn btn-default">
        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a> | <a href="delete/<?php echo $slug; ?>" title = "Удалить фильм/сериал"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></a>
  <?php   } ?>
</h1>
  <hr>
      ...
      <div class="panel-body">
        <?php echo $value['comment_text']; ?>
         ...
         <?php if ($this->dx_auth->is_admin()): ?>
            ...
            <a class="pull-right" href="/comments/delete/<?php echo $value['id'] ?>" title="Удалить комментарий"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></a>  
  ...
  <?php if (!$this->dx_auth->is_logged_in()): ?>
    ...
    <br>
    <p>Чтобы оставить отзыв о фильме, войдите или зарегистрируйтесь! <a href="/auth/login/"> Войти</a><a href="/Auth/register/"> Зарегистрироваться</a></p>

  <?php endif ?>

  <div class="margin-comment"></div>